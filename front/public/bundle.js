(() => {
  var e = {
        ...
        n(294),
          (e.exports = {
            toHtml: function (e) {
              ...
              return (
                c.classList.add("nuevoDiv"),
                (c.innerHTML = `<div >\n    <h3 class="classH3">${t}</h3>\n        <h4 class="classH4">${n}</h4>\n        <img class="classPoster" src="${a}" alt="">\n        <div class="izq">\n           <div>\n              <h4 class="classH4"><b>Director: </b>${r}</h4>\n              <h4 class="classH4"><b>Duración: </b>${o}</h4>\n           </div>   \n        </div>   \n        <div class="der">\n           <div>\n           <h4 class="classH4">★${i}</h4>\n           <h4 class="classH4">${s}</h4>\n           </div>   \n           </div> \n           </div>  \n           `),
                c
              );
            },
          });
      ...
      958: (e) => {
        e.exports = {
          createMovie: function (e) {
            ...
            return t ? alert(t) : alert("Datos enviados");
          },
      ...
      425: (e, t, n) => {
        ...
        const N = c("HTMLFormElement"),
          ...
          F = "0123456789",
          L = { DIGIT: F, ALPHA: _, ALPHA_DIGIT: _ + _.toUpperCase() + F },
          U = c("AsyncFunction");
        var D = {
          isArray: l,
          isArrayBuffer: d,
          ...
          isAsyncFn: U,
          isThenable: (e) => e && (g(e) || p(e)) && p(e.then) && p(e.catch),
        };
        ...
        const Se = (e) => `- ${e}`,
          Re = (e) => D.isFunction(e) || null === e || !1 === e;
        var Ae = (e) => {
          e = D.isArray(e) ? e : [e];
          const { length: t } = e;
          let n, r;
          ...
          for (let s = 0; s < t; s++) {
            ...
            if (
              ((n = e[s]),
              (r = n),
              !Re(n) && ((r = ve[(t = String(n)).toLowerCase()]), void 0 === r))
            )
        ...
        const qe = (function e(t) {
          ...
          return (
            D.extend(o, Le.prototype, n, { allOwnKeys: !0 }),
  ...
  (n.g = (function () {
    ...
    (() => {
      const e = n(294),
        { toHtml: t } = n(638),
        { createMovie: r, clearInputs: o } = n(958),
        s = n(425);
      !(async function () {
        document.getElementById("divFinal").innerHTML = "";
        try {
          !(function (n) {
            const r = document.getElementById("divFinal");
            (r.innerHTML = ""),
              n.forEach((n) => {
                const {
                    title: o,
                  ...
                  f = new e(o, s, i, a, c, u, l),
                  d = t(f);
                r?.appendChild(d);
              });
          })((await s.get("http://localhost:3000/movies")).data);
        } catch (e) {
          console.log("La promesa falló"), console.log(e.message);
        }
      })(),
        document.addEventListener("DOMContentLoaded", () => {
          const e = document.getElementById("movieForm");
          e?.addEventListener("submit", r);
          const t = document.getElementById("clearButton");
